...
const Header = () => {
  ...
  return (
    <header className='flex items-center justify-between px-8 py-4 bg-white border-b mb-8'>
      {/* Stockhome Exchange Logo (SVG placeholder) */}
      <div className='flex items-center cursor-pointer' onClick={() => navigate('/')}>
        <svg
          className='w-10 h-10 text-blue-700'
          viewBox='0 0 40 40'
          fill='currentColor'
          aria-label='Stockhome Exchange Logo'
        >
        ...
        <span className='ml-3 font-bold text-xl text-blue-700'>Stockhome Token Exchange STEX</span>
      </div>
